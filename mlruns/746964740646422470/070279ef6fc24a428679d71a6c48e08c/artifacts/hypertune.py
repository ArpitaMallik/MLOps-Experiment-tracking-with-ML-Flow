...
# Run with MLflow
mlflow.set_experiment('breast_cancer_rf-hp')
...
with mlflow.start_run() as parent:
    ...
    for i in range(len(grid_search.cv_results_['params'])):
        ...
        with mlflow.start_run(nested=True) as child:
            ...
            mlflow.log_metric("rank_test_score", grid_search.cv_results_['rank_test_score'][i])
    ...
    train_df = mlflow.data.from_pandas(train_df) #mlflow has its own data class, so we gotta convert train_df to that class's object
